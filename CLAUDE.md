...
**重要**：除非用户明确要求，否则**禁止主动创建任何文档文件**。

- ❌ **禁止**：针对普通的代码改动、功能修复、Bug修复自动生成 .md 文档
- ❌ **禁止**：创建测试指南、使用说明、技术文档（除非用户明确要求）
- ❌ **禁止**：创建 README、CHANGELOG、API文档等（除非用户明确要求）
- ✅ **允许**：用户明确说"请生成文档"、"写一个说明文档"等才可创建
