...
UPDATE activities SET joined = 5 WHERE id = 'TEST_PUBLIC_UPCOMING';
UPDATE activities SET joined = 7 WHERE id = 'TEST_PUBLIC_ONGOING';
UPDATE activities SET joined = 4 WHERE id = 'TEST_PUBLIC_FINISHED';
UPDATE activities SET joined = 7 WHERE id = 'TEST_PRIVATE_REVIEW';
UPDATE activities SET joined = 5 WHERE id = 'TEST_WITH_GROUPS';
UPDATE activities SET joined = 8 WHERE id = 'TEST_OTHERS_PUBLIC';
